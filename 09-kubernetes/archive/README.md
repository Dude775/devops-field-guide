# Archive - Kubernetes Course Series

Numbered modules from the Kubernetes learning path (series 02–11). Each folder corresponds to one module in the course sequence.

| Series | Topic | Status |
|--------|-------|--------|
| [02 - Installing Tools](./02-installing-tools/) | kubectl, minikube, cluster setup | — |
...
| [07 - Resource Management](./07-resource-management/) | Labels, selectors, requests, limits, LimitRange, QoS classes | in progress |
...
| [10 - Project: Deploying a MongoDB Database](./10-project-deploying-a-mongodb-database/) | Stateful workload end-to-end | — |
| [11 - Security Fundamentals](./11-security-fundamentals/) | RBAC, ServiceAccounts, TLS certificates | lab |
